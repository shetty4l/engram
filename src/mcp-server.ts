 ...
 * and call handlers. Transport-agnostic — callers connect their own
 * transport (stdio, Streamable HTTP, etc.).
 *
 * IMPORTANT: Callers must call initDatabase() before using the server.
 */
...
/** Create a configured MCP Server with all Engram tool handlers. */
